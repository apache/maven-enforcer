...
# Maven Enforcer Extension - The Extended Loving Iron Fist of Maven

The Enforcer Extension provides a way to globally define rules without making use of pom inheritance. This way you don't have to adjust the pom.xml , but you can enforce a set of rules. 

## Usage

General instructions on how to use the Enforcer Plugin can be found on the [usage page](./usage.html).
